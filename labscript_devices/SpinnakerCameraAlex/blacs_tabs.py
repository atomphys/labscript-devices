#####################################################################
#                                                                   #
# /labscript_devices/SpinnakerCameraAlex/blacs_tabs.py              #
#                                                                   #
...
# This is a copy of /labscript_devices/IMAQdxCamera/blacs_tabs.py,
# where we renamed the class IMAQdxCameraTab by SpinnakerCameraTab and used  
# worker_class = 'labscript_devices.SpinnakerCameraAlex.blacs_workers.SpinnakerCameraWorker'
# instead of worker_class = 'labscript_devices.IMAQdxCamera.blacs_workers.IMAQdxCameraWorker'.
...
class SpinnakerCameraTab(DeviceTab):
